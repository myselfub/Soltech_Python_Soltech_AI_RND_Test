...
class APIAgent:
    ...
    def _init_embed_tools(self) -> ObjectIndex:
        ...
        _tool_mapping = SimpleToolNodeMapping.from_objects(_api_tools)
    ...
    def api_agent(
        ...
        try:
            ...
            _agent: ReActAgent = ReActAgent(tools=[], tool_retriever=_api_tools_retriever, llm=self.llm, memory=memory, context=_system_prompt, verbose=True, max_iterations=8)
